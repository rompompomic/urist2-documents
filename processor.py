...
Пустые поля = null. Никаких комментариев."""
        ...
        "егрн_выписка": {
            "keywords": ["выписка из единого государственного реестра недвижимости", "сведения из егрн", "кадастровый номер", "кадастровая стоимость", "объекта недвижимости", "сведения егрн", "егрн", "реестр недвижимости", "росреестр", "единый государственный реестр недвижимости", "право собственности", "выписка росреестр", "недвижимости о правах отдельного лица", "имевшиеся имеющиеся", "объекты недвижимости", "филиал публично правовой компании", "росреестра по республике"],
            "prompt": """Выписка из ЕГРН с ПОДРОБНЫМИ характеристиками объекта недвижимости.

🔴 КРИТИЧЕСКИ ВАЖНО - РАСПОЗНАВАНИЕ ИМУЩЕСТВА:

ЕСЛИ ВИДИШЬ КАДАСТРОВЫЙ НОМЕР (XX:XX:XXXXXXX:XXXX) → ИМУЩЕСТВО ЕСТЬ!
- Даже ОДИН кадастровый номер = объект недвижимости = {"Есть_недвижимость": true}
- Даже если адрес размыт, даже если данных мало - если есть кадастровый номер, имущество ЕСТЬ!
