...
4. "населенный_пункт" - это село, деревня, поселок, пгт (например: "с. Альменево").
5. "улица" - улица, проспект, переулок (например: "пер. Северный").
6. "дом" - просто номер (например: "23").
7. "квартира" - если есть.
...
Пример: "Курганская область, Альменевский район, с. Альменево, пер. Северный, д. 23"
Должно быть:
{{
