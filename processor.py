...
- Сложи "Основной долг" + "Проценты" + "Иное" из детального раздела НИЖЕ в таблице "Сведения о сумме задолженности". НЕ БРАТЬ из "Сумма задолженности на дату передачи финансирования субъекту или возникновения обеспечения исполнения обязательства:"!
...
- Если в краткой таблице "Сумма и валюта обязательства" равняется нулю, то это значит, что это постановление(другой документ) - игнорируй долг, он уже есть.
