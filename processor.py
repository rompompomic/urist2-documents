...
Пустые значения = null. Без комментариев.""",
        ...
        "отчет_окб": {
            ...
            "prompt": """Найди таблицу "ДЕЙСТВУЮЩИЕ КРЕДИТНЫЕ ДОГОВОРЫ" или "АКТИВНЫЕ ДОГОВОРЫ", когда наткнешься на таблицу "ЗАКРЫТЫЕ КРЕДИТНЫЕ ДОГОВОРЫ", начинай игнорировать договоры и не учитывать их.
...
2. В таблице "Основные сведения об обязательстве":
   ...
   - Тип кредита/займа (из строки "Вид займа (кредита)" или аналогичной: Потребительский кредит, Кредитная карта, Микрозайм, Ипотека, Автокредит, и т.д.)
3. В таблице "Задолженность":
   - Найди САМУЮ ПОСЛЕДНЮЮ строку в таблице
   - Возьми значение из столбца "Сумма" (это текущий долг)
   - ИГНОРИРУЙ другие столбцы ("Сумма по осн.долгу", "Сумма по %%", и т.д.)
