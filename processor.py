...
2. Фраза "Не являлся(ется) получателем пенсии" означает, что нет именно ПЕНСИИ. Но человек может получать СОЦИАЛЬНЫЕ ВЫПЛАТЫ (например, по уходу за ребенком-инвалидом, ЛОУ)!
