...
Пустые поля = null, списки допускают [] и null, но ключи обязательны. Без комментариев.""",
        ...
        "налоговое_уведомление": {
            "keywords": ["налоговое уведомление", "транспортный налог", "налог на имущество физических лиц", "всего к уплате", "налового уведомления", "земельный налог", "фнс", "налоговая служба"],
