...
- Комментарии не добавляй"""
        ...
        "пенсии": {
            "keywords": ["справка сфр", "назначенных пенсиях", "ежемесячной денежной выплаты", "едв", "пенсия", "о назначенных пенсиях", "социальных выплатах", "размер пенсии", "пенсионный фонд", "пфр", "справка сфр о назначенных пенсиях", "справка сфр", "справка о размере пенсии и выплатах СФР на текущую дату", "справка о размере пенсии и выплатах СФР", "справка о назначенных пенсиях и социальных выплатах", "пенсии и социальные выплаты", "пенсии и выплаты", "пенсии и социальные выплаты", "пенсии и выплаты", "пенсии и социальные выплаты", "пенсии и выплаты"],
...
2. Фраза "Не являлся(ется) получателем пенсии" означает, что нет именно ПЕНСИИ. 
   ВАЖНОЕ ИСКЛЮЧЕНИЕ: Если в тексте есть фраза "лицом, осуществляющим уход за ребенком-инвалидом" или "лицом, осуществляющим уход за нетрудоспособным гражданином" — ЭТО ОЗНАЧАЕТ, ЧТО ЧЕЛОВЕК ПОЛУЧАЕТ ВЫПЛАТУ ПО УХОДУ!!! 
   В справке СФР этот блок часто написан криво: начинается с "Не являлся ... получателем пенсий ...", а дальше через запятую идет "лицом, осуществляющим уход...". 
   ТРАКТУЙ ЭТО ТАК: "Не является получателем пенсии, НО ЯВЛЯЕТСЯ лицом, осуществляющим уход".
   ЕСЛИ видишь слова "лицом, осуществляющим уход за ребенком-инвалидом" или "нетрудоспособным гражданином" — ПИШИ В СТАТУС: "Является получателем выплаты по уходу за ребенком-инвалидом (нетрудоспособным гражданином)".
   Игнорируй начало предложения "Не являлся..." для этой конкретной части. Это бюрократическая ошибка формулировки, но деньги платят.
3. ВНИМАТЕЛЬНО ищи слова "Установлена", "Назначена", "Является получателем".
   - Если видишь "Ежемесячная выплата лицам, осуществляющим уход за детьми-инвалидами" или подобное — ЭТО ВЫПЛАТА! Извлеки её, её размер и сроки раз не являлся получателем *пенсии*.
   - Если видишь перечисление "Не являлся... получателем... [длинный список]" и НЕТ слов "Установлена/Назначена" про другую выплату — тогда выплат нет.
