...
Если реквизит не найден, ставь null. Никаких дополнительных комментариев.""",
        ...
        "свидетельство_о_рождении": {
            "keywords": ["свидетельство о рождении", "свидетельство о рождении ребенка", "копия свидетельства о рождении", "родился", "родилась", "запись акта о рождении", "ребенок", "загс"],
            "prompt": """Ты обрабатываешь свидетельство(а) о рождении ребенка/детей.

ФОРМАТИРОВАНИЕ: Если текст в CAPS LOCK — приведи к нормальному виду (ФИО с заглавной буквы).

🔴 КРИТИЧЕСКИ ВАЖНО - НЕСКОЛЬКО СВИДЕТЕЛЬСТВ В ОДНОМ PDF:
- В ОДНОМ файле могут быть свидетельства НЕСКОЛЬКИХ детей (2, 3 или больше)!
- Внимательно просмотри ВСЕ страницы документа от начала до конца
- Если видишь ОДНО свидетельство → извлеки ОДНОГО ребенка
- Если видишь ДВА свидетельства → извлеки ОБОИХ детей в массив
- Если видишь ТРИ свидетельства → извлеки ВСЕХ ТРОИХ в массив
- НЕ останавливайся после первого свидетельства, проверь весь документ!

КАК РАЗЛИЧАТЬ РАЗНЫЕ СВИДЕТЕЛЬСТВА:
- Каждое свидетельство = новый ребенок с РАЗНЫМ ФИО
- Если видишь разные серии/номера свидетельств → это разные дети
- Если видишь разные даты рождения → это разные дети
- Двусторонняя копия ОДНОГО свидетельства ≠ два свидетельства
...
Верни JSON:
{
  "Дети": [
    {
      "Ребенок_ФИО": "Полное ФИО первого ребенка",
      "Дата_рождения": "ДД.ММ.ГГГГ",
      "Место_рождения": "...",
      "Мать_ФИО": "...",
      "Отец_ФИО": "...",
    ...
    {
      "Ребенок_ФИО": "Полное ФИО второго ребенка (если есть)",
      "Дата_рождения": "ДД.ММ.ГГГГ",
      "Место_рождения": "...",
      "Мать_ФИО": "...",
      "Отец_ФИО": "...",
...
Если в документе ОДНО свидетельство - массив "Дети" содержит ОДИН элемент.
Если в документе ТРИ свидетельства - массив "Дети" содержит ТРИ элемента.
Если реквизит не найден, ставь null. Никаких дополнительных комментариев.""",
        },
