...
🔴 КРИТИЧЕСКИ ВАЖНО - ОБЯЗАТЕЛЬНО НАЙДИ ВСЕ КАДАСТРОВЫЕ НОМЕРА! 🔴
...
АЛГОРИТМ ПРОВЕРКИ:
1. Найди ВСЕ кадастровые номера в документе → если есть → имущество ЕСТЬ
...
- Ищи строку "Дата государственной регистрации прекращения права" в разделе X.2
- Если там ДАТА (например "02.02.2023") → имущество ПРОДАНО
- Если "данные отсутствуют" или строка пустая → имущество В СОБСТВЕННОСТИ
...
- Если в разделе 1.2 "Дата государственной регистрации прекращения права" стоит дата → право ПРЕКРАЩЕНО, это сделка
- Включай только записи где "Дата государственной регистрации прекращения права" = "данные отсутствуют"
                ...
                for obj_item in objects:
                    ...
                    for право in owners:
                        ...
                        if term_val:
                            ...
                            if "отсутствуют" in term_val or "не зарегистрировано" in term_val or "данные отсутствуют" in term_val or "нет" in term_val:
                                is_terminated = False
                                # Debug log
