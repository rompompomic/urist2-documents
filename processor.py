...
🔴 ВАЖНО ДЛЯ РУКОПИСНЫХ ДОКУМЕНТОВ:
- Если документ содержит РУКОПИСНЫЙ текст (заполнен от руки), пытайся прочитать его, если не можешь - читай печатный
- Внизу документа (или справа) обычно есть ПЕЧАТНЫЙ блок "Место регистрации", "Дата выдачи" с печатью
- Читай именно ПЕЧАТНЫЙ текст — он более надёжный
- Если печатного блока нет, тогда пытайся прочитать рукописный

📋 СТРУКТУРА ДОКУМЕНТА:
1. Первая строка: чья это справка (Гражданин/Гражданка + ФИО)
2. Далее идут строки "муж" / "мужъ" и "жене" / "жена" с данными
3. В конце: "После заключения брака присвоены фамилии: мужу ... жене ..."
4. Справа или внизу: печатный блок с местом регистрации и датой выдачи

🎯 ЧТО ИЗВЛЕКАТЬ:
- ФИО супруга (мужа) - АКТУАЛЬНАЯ ФАМИЛИЯ после брака
- ФИО супруги (жены) - АКТУАЛЬНАЯ ФАМИЛИЯ после брака
- Дата рождения супруга
- Дата рождения супруги
- Дата заключения брака (когда заключили брак, не дата выдачи!)
- Орган ЗАГС/ЗАГС/регистрации (где выдано свидетельство)
- Номер записи акта
- Дата выдачи свидетельства

🔍 КАК НАЙТИ АКТУАЛЬНЫЕ ФАМИЛИИ:
- В документе может быть написано: "заключили брак" или "присвоены фамилии" или "после заключения брака"
- Ищи фразы: "мужу [Фамилия]", "жене [Фамилия]"
- ЭТО и есть актуальные фамилии после брака
- Если такого блока нет, бери фамилии из основного текста

КРИТИЧЕСКИ ВАЖНО:
- Различай ФИО супруга (мужа) и супруги (жены)
- Обязательно извлеки даты рождения обоих супругов
- Дата заключения брака ≠ дата выдачи свидетельства
- Используй АКТУАЛЬНЫЕ фамилии (присвоенные после брака), не девичьи!

Верни ТОЛЬКО JSON:
{
  "Супруг_ФИО": "Фамилия Имя Отчество мужа (актуальная после брака)",
  "Супруг_Дата_рождения": "ДД.ММ.ГГГГ",
  "Супруга_ФИО": "Фамилия Имя Отчество жены (актуальная после брака)",
