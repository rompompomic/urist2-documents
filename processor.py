...
Сразу нормализуй название банка, например: ПАО «Сбербанк», ПАО «Банк ПСБ», ПАО «ВТБ» и т.д.
...
- В старой версии: Тип кредита/займа (из колонки "Вид обязательства" или аналогичной: Потребительский кредит, Кредитная карта, Микрозайм, Ипотека, Автокредит, Необеспеченный кредит, и т.д.). А в новой версии "Источник (кредитор) / Вид обязательства" - в этой колонке указано название банка и вид кредита.
- В старой: Дата начала договора (из колонки "Дата начала договора"). А в новой: Дата начала обязательства (из колонки "Дата начала обязательства")
- В старой: Сумма обязательства по договору (ОБЯЗАТЕЛЬНО! из колонки "Сумма обязательства по договору" - первоначальная сумма кредита). А в новой: Сумма / лимит обязательства (ОБЯЗАТЕЛЬНО! из колонки "Сумма / лимит обязательства" - первоначальная сумма кредита)
- В старой: Текущий долг = "Текущая задолженность" + "Текущая просрочка, сумма". А в новой текущий долг = "Текущая просрочка (осн.долг, %, пени...)", то есть в новой версии уже всё включено в одну колонку "Текущая просрочка (осн.долг, %, пени...)".
