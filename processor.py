...
Дополнительно: 
- Поле "Место_рождения" ОБЯЗАТЕЛЬНО должно быть заполнено в формате: "тип населенного пункта (с сокращением), название, район, область/край". Примеры: "с. Агинское, Саянский р-н, Красноярский край", "г. Москва", "д. Петрово, Рязанская обл.". Если текст нечитабелен — "Место_рождения_не_распознано": true
...
- Извлекай адрес 1:1 как написано в отчете, ничего не меняя (Убери только почтовый индекс и убери капс)! Это очень важно!
