...
- Перечень ВСЕХ назначенных выплат: название выплаты (например "Страховая пенсия по инвалидности", "Ежемесячная денежная выплата"), правовое основание (статья закона), период установления, точный РАЗМЕР (сумма в рублях и копейках), статус НСУ (лекарства, санаторий, проезд).
- Размер ежемесячной денежной выплаты (ЕДВ) и волеизъявление по набору социальных услуг.
- Внимательно ищи суммы! Часто они указаны в колонках таблицы или отдельной строкой "Размер ...: 35 736 руб. 73 коп.".
- Если видите "Пенсия по инвалидности" или подобные, по старости например - обязательно извлеките сумму для расчетов.
- Сформируй ТЕКСТОВОЕ ОПИСАНИЕ СТАТУСА (поле "Текст_статуса"):
  - Напиши одним предложением, получателем каких видов пенсий/пособий является гражданин.
  - БЕЗ СУММ! Только названия выплат.
  - Пример: "Является получателем страховой пенсии по старости, является получателем ежемесячной денежной выплаты ветеранам труда".
  - Если ничего не назначено: "Получателем пенсий, пособий не является".
