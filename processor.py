...
1. Прочитай ФИО обоих супругов из документа (муж И жена)
2. Определи, кто из них ДОЛЖНИК (сравни с ФИО: {debtor_fio})
3. Верни данные СУПРУГА (того, кто НЕ является должником)

ПРИМЕР:
Если {debtor_fio} = "Мансуров Ахмад Тоджидинович"
И в документе:
- муж: МАНСУРОВ АХМАД ТОДЖИДИНОВИЧ, 14.01.1997
- жене: ШАХОВБИЛЛИНЗОДА БИБИРАДЖАБ ШОМУРОД, 06.08.1999
- присвоены фамилии: мужу МАНСУРОВ, жене ШАХОВБИЛЛИНЗОДА

То должник = муж (Мансуров), значит СУПРУГ = жена
Верни:
- Супруг_ФИО: "Шаховбиллинзода Бибираджаб Шомурод"
- Супруг_Дата_рождения: "06.08.1999"

🔴 КРИТИЧЕСКИ ВАЖНО:
- Сравнивай ФИО по фамилии и имени (отчество может отличаться)
- Используй АКТУАЛЬНЫЕ фамилии после брака (из блока "присвоены фамилии")
- Если не можешь точно определить должника - верни данные противоположного пола должника
- Верни ТОЛЬКО ОДНОГО супруга (того, кто не должник)
- Если не можешь прочитать рукописный текст - читай печатный блок внизу
