...
1. ВНИМАТЕЛЬНО прочитай ФИО обоих супругов из документа:
   - муж (или графа "Сочетались браком")
   - жена (или графа "Сочетались браком")
   
2. Определи, кто ДОЛЖНИК:
   - Сравни ФАМИЛИЮ, ИМЯ и ОТЧЕСТВО с {debtor_fio}
   
3. Верни данные СУПРУГА (того, кто НЕ должник):
   - Если должник = муж → верни данные жены
   - Если должник = жена → верни данные мужа

🔴 ОСОБЕННОСТИ ДОКУМЕНТА:
- В свидетельствах СНГ (Таджикистан, Узбекистан и т.д.) текст может быть:
  • Рукописным (читай аккуратно)
  • Печатным дублированием внизу
  • С отчествами в формате "сын/дочь Имя" или "...ович/...овна"
  
- ИЩИТЕ ГРАФЫ:
  • "муж" / "жених" / "сочетался"
  • "жена" / "невеста" / "сочеталась"
  • "присвоены фамилии" (актуальные фамилии ПОСЛЕ брака)
  • даты рождения рядом с ФИО

ПРИМЕР:
Если должник {debtor_fio} станет станет "Мансуров Ахмад Тоджидинович"
И в документе:
- муж: МАНСУРОВ АХМАД ТОДЖИДИНОВИЧ, 14.01.1997
- жена: ШАХОВБИЛЛИНЗОДА БИБИРАДЖАБ ШОМУРОД, 06.08.1999
- присвоены фамилии: мужу МАНСУРОВ, жене ШАХОВБИЛЛИНЗОДА

Сравнение:
- Фамилия должника "Мансуров" = фамилия мужа "Мансуров" ✅
- Имя должника "Ахмад" = имя мужа "Ахмад" ✅
→ ДОЛЖНИК = МУЖ → СУПРУГ = ЖЕНА

Верни:
- Супруг_ФИО: "Шаховбиллинзода Бибираджаб Шомурод" (актуальная фамилия жены)
- Супруг_Дата_рождения: "06.08.1999"

🔴 КРИТИЧЕСКИ ВАЖНО:
- ВСЕГДА возвращай данные супруга (не пустой JSON!)
- Используй АКТУАЛЬНЫЕ фамилии после брака (из графы "присвоены фамилии")
- Если рукописный текст нечитаемый - используй печатный блок внизу документа
- Если не уверен кто должник - анализируй пол по имени и отчеству
- НЕ ОСТАВЛЯЙ Супруг_ФИО пустым/null если есть ХОТЬ ОДИН супруг в документе!
