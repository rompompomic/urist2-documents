...
Верни JSON строго в формате:
{
  ...
  "Прописка": "Челябинская область, г. Челябинск, ул. Ленина, д. 10, кв. 5",  # ОБЯЗАТЕЛЬНО ПОЛНЫЙ АДРЕС С ОБЛАСТЬЮ/КРАЕМ! Формат: область/край, город, улица, дом, корпус (если есть), квартира
