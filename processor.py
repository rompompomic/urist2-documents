...
4. Штампы о семейном положении (стр. 7-8):
        КРИТИЧЕСКОЕ ПРАВИЛО:
        Если есть читаемый штамп о браке, а после него расположен следующий штамп, который: нечитаемый, смазан, криво поставлен, частично виден, невозможно достоверно определить как брак или развод, то НЕ ИСПОЛЬЗУЙ предыдущий штамп о браке как актуальный статус. В этом случае итоговый статус ставь: "Не женат" / "Не замужем"
