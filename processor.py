...
КРИТИЧЕСКИ ВАЖНО ПРО ДОЛГ:

• Значение "Сумма" в JSON —
  брать ИСКЛЮЧИТЕЛЬНО из колонки "Общая задолженность"
  таблицы "ДЕЙСТВУЮЩИЕ КРЕДИТНЫЕ ДОГОВОРЫ".

• НЕ складывать:
  "Общая задолженность" + "Просроченная задолженность".

• НЕ использовать строку:
  "Сумма задолженности на дату передачи финансирования субъекту
   или возникновения обеспечения исполнения обязательства".

• Детальную таблицу "Сведения о сумме задолженности" использовать
  ТОЛЬКО для проверки корректности данных,
  но НИКОГДА не для расчёта поля "Сумма".
